...
public class MainActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks{
     ...
     */
    private class MakeRequestTask extends AsyncTask<Void, Void, List<LibraryDetails>> {
         ...
         */
        @Override
        protected List<LibraryDetails> doInBackground(Void... params) {
            try {
         ...
         * @throws IOException
         */
        private List<LibraryDetails> getDataFromApi() throws IOException {
            String spreadsheetId = "1DEY_HLu5S_GN3oKH-37xGHJBZ1oy6kMBl4ywGij9gwA";
            String range = "Sheet1";
            List<LibraryDetails> results = new ArrayList<>();
            ...
            if (values != null) {
                ...
                for (int i = 1; i < values.size(); i++) {
                    ...
                    try {
                        ...
                        LibraryDetails ld = new LibraryDetails(row.get(0).toString(),row.get(1).toString());
...
//                        Integer.parseInt(row.get(11).toString())
        ...
        @Override
        protected void onPostExecute(List<LibraryDetails> output) {
            ...
            if (output == null || output.size() == 0) {
                ...
                mRvLibraryList.setAdapter(libraryAdapter);
                mRvLibraryList.setLayoutManager(new LinearLayoutManager(getApplicationContext()));
            }
        ...
        protected void onCancelled() {
            ...
            if (mLastError != null) {
                if (mLastError instanceof GooglePlayServicesAvailabilityIOException) {
                    ...
                    startActivityForResult(
                            ((UserRecoverableAuthIOException) mLastError).getIntent(), MainActivity
